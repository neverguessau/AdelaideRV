						...
						<div class="wrapper">
							<ul>
								...
								<?php while( have_rows('sales_contacts', 'options') ): the_row(); ?>
									...
									<a href="mailto:<?php echo esc_html( antispambot( get_sub_field('email') ) ); ?>"><?php echo esc_html( antispambot( get_sub_field('email') ) ); ?></a>
								</li>
								<?php endwhile; ?>
								<?php endif; ?>
							...
							<ul>
								...
								<?php if( have_rows('service_contacts', 'options') ): ?>
									<?php while( have_rows('service_contacts', 'options') ): the_row(); ?>
									<li class="icon">
										<i class="fa-regular fa-envelope"></i>
										<a href="mailto:<?php echo esc_html( antispambot( get_sub_field('email') ) ); ?>"><?php echo esc_html( antispambot( get_sub_field('email') ) ); ?></a>
									</li>
