        ...
        <div class="container">
            <div class="row">
                <div class="hero-content-wrapper">
                    <h1 class="aos-init aos-animate" data-aos="fade-down"><?php the_field('heading') ?></h1>

                    <div class="brands-search mobile" data-aos="fade-down">
                        <a class="search-btn">Search Items</a>
                    </div>

                    <form id="brands-search-form" action="<?php echo home_url('/our-stock') ?>"
                          class="brands-search-form desktop form-control aos-init aos-animate" data-aos="fade-down">

                        <div class="form-group">
                            <select id="type" name="type" class="form-control">
                                <option value="" selected>Type</option>
                                <option value="new_used-pre-owned">Pre-owned</option>
                                <option value="new_used-new">New</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <select name="make" id="make" class="form-control">
                                ...
                                <?php
                                $allowed_brands = array('Supreme', 'Leader', 'Goldstream', 'Interstate');
                                foreach ($allowed_brands as $brand_name) {
                        ...
                        <div class="form-group">
                            <select name="sleeps" id="sleeps" class="form-control">
                                ...
                                <option value="_sleeps-0">0</option>
            ...
            <div class="row usp-container aos-init aos-animate" data-aos="fade-down">
                        ...
                        <g clip-path="url(#clip0_3_64)">
                            ...
                            <g mask="url(#mask0_3_64)">
                                <path d="M17.5185 37.2863L10.5868 32.0944C8.65522 30.6477 7.37749 28.4928 7.03472 26.104L6.73071 23.9863"
                                      stroke="white" stroke-width="2.92969" stroke-miterlimit="10"/>
...
<div class="mobile-brand-search-wrapper">
    ...
    <form id="brands-search-form-mobile" action="<?php echo home_url('/our-stock') ?>"
          class="brands-search-form mobile form-control">

        <div class="form-group">
            <select id="type-mobile" name="type-mobile" class="form-control">
                <option value="" selected>Type</option>
                <option value="new_used-pre-owned">Pre-owned</option>
                <option value="new_used-new">New</option>
            </select>
...
<!--                <option value="_body-camper-trailer">Camper Trailer</option>-->
        ...
        <div class="form-group">
            <select name="minPrice-mobile" id="minPrice-mobile" class="form-control">
...
<script>
    ...
    document.getElementById("brands-search-form").addEventListener("submit", function (event) {
        ...
        if (priceValue !== '' && minPriceValue !== '') {
            ...
            resultUrl += '?min__price=' + encodeURIComponent(minPriceValue);
        } else if (priceValue !== '') {
...
<script>
    ...
    document.getElementById("brands-search-form-mobile").addEventListener("submit", function (event) {
        ...
        const typeValue = document.getElementById("type-mobile").value;
        ...
        const minPriceValue = document.getElementById("minPrice-mobile").value;
        ...
        if (priceValue !== '' && minPriceValue !== '') {
            mobileResultUrl += '?max__price=' + encodeURIComponent(priceValue) + '&min__price=' + encodeURIComponent(minPriceValue);
        } else if (minPriceValue !== '') {
            mobileResultUrl += '?min__price=' + encodeURIComponent(minPriceValue);
        } else if (priceValue !== '') {
...
<script>// homepage slider
    jQuery(document).ready(function ($) {
        ...
        if (window.innerWidth < 1024) {
            $('.homepage-hero .brand-search-wrapper .usp-container').owlCarousel({
                items: 1,
                autoplay: false,
                loop: false,
                nav: true,
