...
<?php 
    ...
    $img_url_26 = $img_path . get_field('stock_number', get_the_ID()) . "_26.jpg";
    $img_url_27 = $img_path . get_field('stock_number', get_the_ID()) . "_27.jpg";
    $img_url_28 = $img_path . get_field('stock_number', get_the_ID()) . "_28.jpg";
    $img_url_29 = $img_path . get_field('stock_number', get_the_ID()) . "_29.jpg";
    $img_url_30 = $img_path . get_field('stock_number', get_the_ID()) . "_30.jpg";
?>
                    ...
                    <div class="main-img">
                        <?php // check if featured image url exists
                            ...
                            if (urlExists($urlToCheck)) { ?>
                                <a class="gallery" href="<?php echo $urlToCheck ;?>">
        ...
        <div class="container">
            ...
            <?php if( have_rows('sales_contacts', 'options') ): ?>
                <?php while( have_rows('sales_contacts', 'options') ): the_row(); ?>
                    <a href="mailto:<?php echo esc_html( antispambot( get_sub_field('email') ) ); ?>" class="btn-lg call-us-btn desktop-only">Enquire Now</a>
                <?php endwhile; ?>
            <?php endif; ?>
        </div>
