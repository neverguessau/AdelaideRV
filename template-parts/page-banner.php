...
// Section classes
$section_classes = 'page-banner lovely-page-banner';
if ($has_form) {
    ...
    <div class="page-banner__inner<?php echo $has_form ? ' page-banner__inner--split' : ''; ?>">
        ...
        <div class="content"<?php if (!empty($title_top_pct)) : ?> style="top:<?php echo esc_attr((float)$title_top_pct); ?>%"<?php endif; ?>>
            ...
            <?php if (!empty($page_subtitle)) : ?>
                <h1 class="page-subtitle" data-aos="fade-up"><?php echo esc_html($page_subtitle); ?></h1>
            <?php endif; ?>
...
<style>
    ...
    /* CTA color classes selected via ACF */
    .lpb-btn {
        display: inline-flex;
        align-items: center;
